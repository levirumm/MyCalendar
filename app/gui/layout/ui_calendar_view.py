...
class Ui_MyCalendar(object):
    def setupUi(self, MyCalendar):
        ...
        sizePolicy4.setHeightForWidth(self.previous_month_button.sizePolicy().hasHeightForWidth())
        self.previous_month_button.setSizePolicy(sizePolicy4)
        ...
        sizePolicy5.setHeightForWidth(self.next_month_button.sizePolicy().hasHeightForWidth())
        self.next_month_button.setSizePolicy(sizePolicy5)
        ...
        sizePolicy6.setHorizontalStretch(24)
        ...
        sizePolicy7.setHeightForWidth(self.month_year_label.sizePolicy().hasHeightForWidth())
        self.month_year_label.setSizePolicy(sizePolicy7)
        ...
        sizePolicy9.setHeightForWidth(self.left_column_container.sizePolicy().hasHeightForWidth())
        self.left_column_container.setSizePolicy(sizePolicy9)
        ...
        sizePolicy10.setVerticalStretch(19)
        ...
        sizePolicy13.setHeightForWidth(self.calendar_grid_container.sizePolicy().hasHeightForWidth())
        self.calendar_grid_container.setSizePolicy(sizePolicy13)
    ...
    def retranslateUi(self, MyCalendar):
        ...
        self.refresh_button.setText(QCoreApplication.translate("MyCalendar", u"PushButton", None))
